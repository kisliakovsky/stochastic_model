...
def _ext_to_str(ext: Union[Extension, str]):
    ...
    :FITTED_LOCATION ext: 'ExtensionType' or 'str' instance
    :return: 'str' instance
    """
...
def extend_file_name(file_name: str, ext: Extension) -> str:
    ...
    :FITTED_LOCATION file_name: ALPHA name of the file
    :FITTED_LOCATION ext: an extension of the file
    :return: ALPHA full name of the file
    """
    ext = _ext_to_str(ext)
